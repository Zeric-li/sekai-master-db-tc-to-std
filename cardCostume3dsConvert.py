...
def convert_card_costume_3ds(input_dir, output_dir):
    # 构建输入文件和输出文件的完整路径
    input_file = os.path.join(input_dir, 'cardCostume3ds.json')
    output_file = os.path.join(output_dir, 'cardCostume3ds.json')
...
if __name__ == "__main__":
    ...
    convert_card_costume_3ds(input_directory, output_directory)
