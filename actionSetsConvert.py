...
def convert_action_sets(input_dir, output_dir):
    # 构建输入文件和输出文件的完整路径
    input_file = os.path.join(input_dir, 'actionSets.json')
    output_file = os.path.join(output_dir, 'actionSets.json')
    ...
    fields = [
        ...
        (5, "scriptId"),
        (6, "characterIds"),
        (7, "archiveDisplayType"),
        (8, "archivePublishedAt"),
        (9, "releaseConditionId")
    ]
...
if __name__ == "__main__":
    ...
    convert_action_sets(input_directory, output_directory)
