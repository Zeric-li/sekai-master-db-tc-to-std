...
def convert_challenge_live_high_score_rewards(input_dir, output_dir):
    # 构建输入文件和输出文件的完整路径
    input_file = os.path.join(input_dir, 'challengeLiveHighScoreRewards.json')
    output_file = os.path.join(output_dir, 'challengeLiveHighScoreRewards.json')
...
if __name__ == "__main__":
    ...
    convert_challenge_live_high_score_rewards(input_directory, output_directory)
